...
if (!productCols.some(col => col.name === 'cost_price')) {
...
if (productCount.count === 0) {
  ...
  const products = [
    ['Classic School Backpack', 'Abanyeshuri', 25000, 15000, 'Durable backpack for students.', JSON.stringify(['https://picsum.photos/seed/bag1/400/400']), 50],
    ['Elegant Leather Handbag', 'Abakobwa', 45000, 28000, 'Stylish leather handbag.', JSON.stringify(['https://picsum.photos/seed/bag2/400/400']), 30],
    ['Urban Sling Bag', 'Urubyiruko', 15000, 8000, 'Trendy youth bag.', JSON.stringify(['https://picsum.photos/seed/bag3/400/400']), 100],
    ['Laptop Briefcase', 'Abagabo', 55000, 35000, 'Professional bag.', JSON.stringify(['https://picsum.photos/seed/bag4/400/400']), 20],
    ['Modern Tote Bag', 'Abagore', 35000, 22000, 'Daily use tote.', JSON.stringify(['https://picsum.photos/seed/bag5/400/400']), 40]
  ];
